...
class GeminiLiveClient(
    ...
    private val client = OkHttpClient.Builder()
        ...
        .pingInterval(20, TimeUnit.SECONDS) // Connection active rakhar jonno
        .build()

    // Apnar asol model name
    ...
    fun start() {
        ...
        webSocket = client.newWebSocket(request, object : WebSocketListener() {
            ...
            override fun onMessage(webSocket: WebSocket, text: String) {
                // Shob data JSON a ashe, seta handle korun
                handleResponse(text)
            }

            override fun onMessage(webSocket: WebSocket, bytes: ByteString) {
                // Gemini Live API shob shomoy JSON Text pathay.
                // Binary frame handle korar dorkar nei, tobe safety er jonno:
                try {
    ...
    private fun handleResponse(jsonString: String) {
        try {
            ...
            // Setup confirm korar sothik niyom
