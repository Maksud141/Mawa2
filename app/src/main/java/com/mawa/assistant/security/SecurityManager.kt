 ...
 *
 * ADDED: isPackageLocked() — AccessibilityHelperService er jonno
 */
object SecurityManager {

    private const val TAG = "MAWA_SECURITY"
    private const val KEYSTORE_PROVIDER = "AndroidKeyStore"
    private const val KEY_ALIAS = "MAWA_MASTER_KEY"
    private const val AES_MODE = "AES/GCM/NoPadding"
    private const val GCM_TAG_LENGTH = 128

    private const val PREFS_NAME = "mawa_security_prefs"
    ...
    fun isPackageLocked(context: Context, packageName: String): Boolean {
        ...
        val systemApps = listOf(
            ...
            "com.mawa.assistant" // Nijeke lock kora atkano holo
        )
        if (systemApps.contains(packageName)) return false // Settings loop eranor jonno ekhon lock hobe na

        // Locked packages list check korun
