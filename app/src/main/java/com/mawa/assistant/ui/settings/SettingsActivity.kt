...
import com.mawa.assistant.security.SecuritySettingsActivity
...
class SettingsActivity : AppCompatActivity() {
    ...
    private fun setupListeners() {
        ...
        findViewById<View>(R.id.deviceAdminCard).setOnClickListener {
            if (!devicePolicyManager.isAdminActive(componentName)) {
                val intent = Intent(DevicePolicyManager.ACTION_ADD_DEVICE_ADMIN).apply {
                    ...
                    putExtra(DevicePolicyManager.EXTRA_ADD_EXPLANATION, "MAWA needs admin to control system.")
                }
        ...
        setDefaultAssistantBtn.setOnClickListener {
            try {
                ...
                Toast.makeText(this, "MAWA ke Default Assistant chuno 👆", Toast.LENGTH_LONG).show()
            } catch (e: Exception) {
    ...
    private fun checkAndRequestPermissions() {
        ...
        if (missing.isNotEmpty()) {
            ...
            Toast.makeText(this, "Shob permissions already granted! ✅", Toast.LENGTH_SHORT).show()
    ...
    override fun onRequestPermissionsResult(requestCode: Int, permissions: Array<out String>, grantResults: IntArray) {
        ...
        if (requestCode == PERMISSIONS_REQUEST_CODE) {
            ...
            if (granted == total) {
                Toast.makeText(this, "Shob permissions milgeche! ✅", Toast.LENGTH_SHORT).show()
            } else {
                Toast.makeText(this, "$granted/$total permissions peyechhi ⚠️", Toast.LENGTH_LONG).show()
                ...
                if (permanentlyDenied.isNotEmpty()) {
                    AlertDialog.Builder(this)
                        ...
                        .setMessage("Kuchu permissions permanently deny hoye geche. Settings theke manually enable koro.\n\n${permanentlyDenied.joinToString("\n") { "• ${it.split('.').last()}" }}")
    ...
    private fun updateCallAnnounceStatus(enabled: Boolean) {
        callAnnounceStatusText.text = if (enabled) {
            "📢 Call ashle MAWA naam bolbe"
        } else {
            "🔇 Call announce bandho ache"
        }
    ...
    private fun savePreferences() {
        val prefs = getSharedPreferences("mawa_prefs", Context.MODE_PRIVATE).edit()
        ...
        prefs.apply()
        Toast.makeText(this, "Settings Saved! MAWA updated. ✅", Toast.LENGTH_SHORT).show()
        finish()
    }
