...
# 🤖 MAWA AI Assistant — Complete Setup Guide
## ⚡ Quick Start (5 Steps)
...
### Step 2: Import Project
 ...
 2. **File → Open** → Select the MAWA folder
...
```
**ic_mawa_notif.xml** (Notification Icon — Updated to mawa)
```xml
<vector xmlns:android="http://schemas.android.com/apk/res/android"
    android:width="24dp" android:height="24dp"
    android:viewportWidth="24" android:viewportHeight="24">
 ...
 * Find **MAWA** in the list → Enable it
 * Come back → green checkmark ✅ should appear
### 3. Enable Overlay Permission
 * Settings → Apps → MAWA → Display over other apps → Allow
### 4. Set Prime Contact
 * Settings → Prime Contact section
 * Enter close friend's name + phone number
 * Say: "MAWA, call my close friend" → it calls them instantly!
### 5. Set Personality
 * GF Mode 💖 = Banglish, emotional, caring
 * Professional 💼 = Formal English
 * Assistant 🤖 = Balanced, Friendly
## 🎤 How to Use
### Voice Commands

| Say this | MAWA does this |
| :--- | :--- |
...
### Overlay Trigger
 * **Double press power button** → MAWA orb appears on screen
 * Tap orb → opens MAWA app
 * Drag orb anywhere on screen
### Incoming Call Handling
 1. Someone calls
 2. MAWA automatically says: *"Sir, [Name] er call ashche... uthabo নাকি reject korbo?"*
 3. Say **"Uthao"** → call accepted
 4. Say **"Reject karo"** → call rejected
 5. MAWA goes back to sleep after call decision
## 🏗️ Project Structure
```
MAWA/
├── app/src/main/
│   ├── java/com/mawa/assistant/
│   │   ├── ai/
...
│   │   │   ├── MawaOverlayService.kt          ← Floating orb overlay
...
| Mic not working | Grant RECORD_AUDIO permission in phone Settings → Apps → MAWA |
...
## 🔑 Getting Your Gemini API Key
 ...
 4. Paste in MAWA Settings → API Key field
 ...
 * ✅ **GF Mode** — Banglish, emotional personality
 ...
 * ✅ **Red Screen Effect** — Screen tints red when MAWA is active
 * ✅ **Overlay Orb** — Floats on home screen like Google Assistant
 * ✅ **Power Button Trigger** — Double press → MAWA activates
